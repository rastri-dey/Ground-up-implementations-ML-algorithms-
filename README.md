...
| 3 | CNN | PyTorch | CIFAR10 | [Github](algorithms/CNN_cifar_pytorch.py)  | [Colab](notebooks/CNN_cifar_pytorch.ipynb) | | |Perfect base reference for all PyTorch Models |22 mins|0.63|
...
| 6 | RNN from Scratch | PyTorch |  |  | [Colab](notebooks/RNN_scratch_pytorch.ipynb) | | |Pure Python implementation |
