...
| 8 | Large Language Model using Generative Pre-Trained Transformers | PyTorch |[Edith Wharton's <br> "The Verdict"](https://en.wikisource.org/wiki/The_Verdict)|| [Colab]()||||