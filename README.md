...
| 3 | Convolutional Neural Network | PyTorch | CIFAR10 | [Github](algorithms/CNN_cifar_pytorch.py)  | [Colab](notebooks/CNN_cifar_pytorch.ipynb) |22 mins|0.63|Perfect base reference for all PyTorch Models |
| 4 | Convolutional Neural Network | PyTorch | MNIST |  | [Colab](notebooks/CNN_mnist_pytorch.ipynb) |2 mins |0.96 |Reuse the Pytorch CNN model (prepared for CIFAR10) to train on MNIST  |
...
| 6 | Recurrent Neural Network <br> (from Scratch) | No PyTorch module used | Book by H G Wells "The Time Machine" |  | [Colab](notebooks/RNN_scratch_pytorch.ipynb) | 20 mins |Perplexity=1.2 |Pure Python implementation |
| 7 | Recurrent Neural Network | PyTorch |  | | [Colab](notebooks/RNN_pytorch.ipynb) | | |*Ongoing*| 