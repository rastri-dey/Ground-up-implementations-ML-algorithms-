...
| 8 | Large Language Model | PyTorch |[Edith Wharton's <br> "The Verdict"](https://en.wikisource.org/wiki/The_Verdict)|[Colab](LLM_scratch.ipynb)|28 s| Perplexity = 1.9|Using Generative Pre-Trained Transformers|